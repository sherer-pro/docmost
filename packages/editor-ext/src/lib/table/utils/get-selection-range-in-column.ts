...
export function getSelectionRangeInColumn(
  ...
  for (let i = startIndex; i <= endIndex; i++) {
    const maybeCells = getCellsInColumn(i, selection);
  ...
  const firstSelectedColumnCells = getCellsInColumn(startIndex, selection);
  ...
  for (let i = endIndex; i >= startIndex; i--) {
    const columnCells = getCellsInColumn(i, selection);
