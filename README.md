...
For the current candidate the only accepted release tag is `v1.2.8`. Follow the
[v1.2.8 upgrade and rollback notes](./apps/server/docs/release-notes/v1.2.8.md)
before deployment.
