...
- переносимые настройки доступности тегов в архивах пространства schema v4;
...
- безопасная материализация устаревших `pageEmbed` при импорте и экспорте; создание новых live-встраиваний целой страницы не входит в публичный контракт;
...
Архив Docmost schema v4 сохраняет и переназначает только те синхронизированные
связи, источник которых находится внутри архива. Внешние связи получают
проверенный по ACL snapshot и при импорте становятся обычным содержимым.
