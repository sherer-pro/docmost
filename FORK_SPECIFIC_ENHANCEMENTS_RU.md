...
момент показан только один сценарий. Устойчивые hash-ссылки ведут к помощнику,
поиску во время ответа, внешнему RAG API, встроенному Open WebUI RAG Sync,
входящему `/mcp`, исходящим MCP-серверам, безопасности и диагностике; кнопки
«Назад» и «Вперёд» переключают те же панели.
...
- фильтры поиска по пространству, типу содержимого, метке страницы и inline-тегам TBD/TODO;
