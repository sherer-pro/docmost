...
Возможности, ранее зависевшие от отдельных модулей Enterprise Edition, включая SSO, MFA, комментарии, расширенный поиск и управление публичным доступом, реализованы непосредственно в core-части форка. Репозиторий распространяется по AGPL 3.0 и не содержит отдельного enterprise-дерева кода.
