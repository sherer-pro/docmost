...
const RouteError = lazy(() => import("@/components/ui/route-error"));
const AuthenticatedError404 = lazy(() =>
  import("@/pages/errors/authenticated-error-404").then((module) => ({
    default: module.AuthenticatedError404,
  })),
);
...
const SpaceSettingsPage = lazy(
  () => import("@/features/space/components/settings/space-settings-page"),
);
...
export const appRoutes = createRoutesFromElements(
  ...
  >
    ...
    <Route element={<Layout />}>
      ...
      <Route path={"/s/:spaceSlug/dictionary"} element={<SpaceDictionary />} />
      <Route path={"/s/:spaceSlug/templates"} element={<SpaceTemplates />} />
